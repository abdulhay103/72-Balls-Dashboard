...
gj.widget = function () {
    ...
    function (a) {
        ...
        config: {
            base: {
                ...
                expandedRows: [],
                icons: {
                    expandRow: '<i class="fas fa-long-arrow-alt-right"></i>',
        ...
        config: {
            ...
            materialicons: {
                icons: {
                    ...
                    previous: '<i class="fas fa-long-arrow-alt-right" />',
                    next: '<i class="fas fa-long-arrow-alt-right" />',
        ...
        base: {
            ...
            icons: {
                expand: '<i class="fas fa-long-arrow-alt-right" />',
    ...
    function (a) {
        ...
        base: {
            ...
            locale: "en-us",
            icons: {
                rightIcon: '<i class="cal far fa-calendar-alt"></i>',
                previousMonth: '<i class="fas fa-long-arrow-alt-right"></i>',
                nextMonth: '<i class="fas fa-long-arrow-alt-right"></i>'
            },
            fontSize: void 0,
            size: "default",
            modal: !1,
